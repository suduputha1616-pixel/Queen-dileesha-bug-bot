...
*𝐁𝐎𝐓 𝐂𝐎𝐑𝐑𝐄𝐂𝐓𝐄𝐑 - ꪶ𝙬𝙝𝙞𝙩𝙚 𝙩𝙖𝙙𝙖𝙨𝙝𝙞ꫂ*


*𝐑𝐄𝐏𝐎 𝐒𝐈𝐓𝐄 - ඒම එකක් එන්නෙ නැති වෙයි😁*

*බග් බොට් කෙනෙක් නිසා ඩව්න්ලෝඩ්න් කමාන්ඩ් මොකුත්ම ඇඩ් කරලා නැ😓පහත කමාන්ඩ් පමනක් පාවිච්චි කරන්න*

*බග් මෙනු සදහා - .bugmenu*
*වන් විඋ මැසෙජ් ගන්න - .getvv*

*බොට් දාන් ඉද්දි ඇන්ටි ඩිලේට් වැඩ 😁අනෙක් ටික හදාගන්න .setmy කමාන්ඩ් එක යූස් කරන්න*
*ඇන්ටි කෝල් on කරන්න එපා😒😓*
...
conn.sendMessage(conn.user.id,{ text: up, contextInfo: {
        ...
        externalAdReply: { 
          ...
          body: 'ලස්සන ටඩාෂි බබහ්ගෙ වැඩක්🐣🖇️💐',
          mediaType: 1,
